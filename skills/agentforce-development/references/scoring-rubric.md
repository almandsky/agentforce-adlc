...
|----------|--------|--------------|
| Structure & Syntax | 15 | All required blocks present (`config`, `system`, `start_agent`, at least one `topic`). Proper nesting. Consistent tab indentation. No mixed tabs/spaces. Valid field names. All string values double-quoted. |
